...
var REQUIRED_EXTENSIONS = ['css', 'jpg', 'png', 'svg', 'js', 'json'];
...
var StandardWebpack = {
  validate: function(webpackConfig) {
    ...
    invariant(webpackConfig.resolve.alias.hasOwnProperty('react-dom'), 'You must add a `resolve.alias.react-dom` field');
