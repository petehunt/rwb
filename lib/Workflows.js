      ...
      var config = {
        ...
        module: {
          loaders: [
            {
              test: /\.js$/,
              loader: require.resolve('react-hot-loader') + '!' + require.resolve('babel-loader') + '?presets=es2015&presets=react',
              include: packageRoot,
            },
            {
              test: /\.json$/,
    ...
    var config = {
      ...
      module: {
        loaders: [
          {
            test: /\.js$/,
            loader: require.resolve('babel-loader') + '?presets=es2015&presets=react',
            include: packageRoot,
          },
          {
            test: /\.json$/,
