...
function generateConfig(dest) {
  if (dest === 'client') {
    ...
    commonConfig.module.loaders[0].query.plugins = [].concat(
      require.resolve('react-hot-loader/babel'),
      commonConfig.module.loaders[0].query.plugins
    );
    ...
    commonConfig.output = {
      ...
      filename: RWB_DISABLE_CACHEBUSTER ? 'bundle.js' : 'bundle-[contenthash].js',
    };
